...
/* harmony import */ var _models_destination_model_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/destination-model.js */ "./src/models/destination-model.js");
/* harmony import */ var _models_offer_model_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/offer-model.js */ "./src/models/offer-model.js");
/* harmony import */ var _models_point_model_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/point-model.js */ "./src/models/point-model.js");
...
class Api {
  ...
  getDestinations() {
    return this._load({url: `destinations`})
      ...
      .then(_models_destination_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseDestinations);
  }

  getPoints() {
    return this._load({url: `points`})
      .then((response) => response.json())
      .then(_models_point_model_js__WEBPACK_IMPORTED_MODULE_2__["default"].parsePoints);
  }

  getOffers() {
    return this._load({url: `offers`})
      .then((response) => response.json())
      .then(_models_offer_model_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseOffers);
  }
  ...
  createPoint(point) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_point_model_js__WEBPACK_IMPORTED_MODULE_2__["default"].parsePoint);
  }
...
/* harmony import */ var _models_destination_model_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/destination-model.js */ "./src/models/destination-model.js");
/* harmony import */ var _models_offer_model_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/offer-model.js */ "./src/models/offer-model.js");
...
class Provider {
  ...
  getPoints() {
    ...
    return Promise.resolve(_models_point_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints(storePoints));
  }
  ...
  getDestinations() {
    ...
    this._isSynchronized = false;
    return Promise.resolve(_models_destination_model_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseDestinations(storeDestinations));
  }
  ...
  getOffers() {
    ...
    this._isSynchronized = false;
    return Promise.resolve(_models_offer_model_js__WEBPACK_IMPORTED_MODULE_2__["default"].parseOffers(storeOffers));
  }
  ...
  createPoint(point) {
    ...
    const fakeNewPoint = _models_point_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(Object.assign({}, point.toRAW(), {id: fakeNewPointId}));
    this._isSynchronized = false;
  ...
  updatePoint(id, point) {
    ...
    const fakeUpdatedPoint = _models_point_model_js__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoint(Object.assign({}, point.toRAW(), {id}));
    this._isSynchronized = false;
...
/***/ "./src/components/add-edit-point.js":
/*!******************************************!*\
  !*** ./src/components/add-edit-point.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AddEditPoint; });
...
const createAddEditPointTemplate = (point, mode, options, offers, destinations) => {
  ...
  const description = he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(currentDescription ? currentDescription : ``);
  ...
  const isFavorite = (mode === _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].ADD) ? `` : createFavoriteButtonTemplate(point.isFavorite);
  const rollupButton = (mode === _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].ADD) ? `` : createRollupButtonTemplate();
  const deleteButtonText = (mode === _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].ADD ? externalData.cancelButtonText : externalData.deleteButtonText);
      ...
      <header class="event__header">
        <div class="event__type-wrapper">
          <label class="event__type  event__type-btn" for="event-type-toggle-1">
            ...
            <img class="event__type-icon" width="17" height="17" src="${_const_js__WEBPACK_IMPORTED_MODULE_2__["TYPE_TO_ICON"][pointType.toLowerCase()]}" alt="${pointType ? `Event type icon` : ``}">
          </label>
        ...
        <div class="event__field-group  event__field-group--destination">
          <label class="event__label  event__type-output" for="event-destination-1">
            ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["capitalizeString"])(pointType)} ${pointType ? _const_js__WEBPACK_IMPORTED_MODULE_2__["TYPE_TO_PLACEHOLDER"][pointType.toLowerCase()] : ``}
          </label>
...
class AddEditPoint extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  ...
  setFavoriteButtonClickHandler(handler) {
    if (this.getElement().querySelector(`.event__favorite-checkbox`)) {
      this.getElement().querySelector(`.event__favorite-checkbox`).addEventListener(`click`, lodash_debounce__WEBPACK_IMPORTED_MODULE_5___default()(handler, DEBOUNCE_TIMEOUT));
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(startDateElement, {
      altInput: true,
      allowInput: true,
      enableTime: true,
    ...
    this._flatpickrEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(endDateElement, {
      altInput: true,
      allowInput: true,
      enableTime: true,
  ...
  _subscribeOnEvents() {
    ...
    startDateElement.addEventListener(`change`, () => {
      ...
      this._flatpickrEndDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(endDate, {
        altInput: true,
        allowInput: true,
        enableTime: true,
    ...
    endDateElement.addEventListener(`change`, () => {
      ...
      this._flatpickrStartDate = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(startDate, {
        altInput: true,
        allowInput: true,
        enableTime: true,
...
const formatDuration = (duration) => {
  ...
  const durationDays = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationDays"])(duration) > 0 ? `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationDays"])(duration)}D` : ``;
  const durationHours = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationHours"])(duration) > 0 || Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationDays"])(duration) > 0 ? `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationHours"])(duration)}H` : ``;
  const durationMinutes = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationHours"])(duration) > 0 || Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationDays"])(duration) > 0 || Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationMinutes"])(duration) > 0 ? `${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDurationMinutes"])(duration)}M` : ``;
  ...
  `<li class="trip-events__item">
    <div class="event">
      <div class="event__type">
        <img class="event__type-icon" width="42" height="42" src="${_const__WEBPACK_IMPORTED_MODULE_0__["TYPE_TO_ICON"][point.type]}" alt="Event type icon">
      </div>
      <h3 class="event__title">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["capitalizeString"])(point.type)} ${_const__WEBPACK_IMPORTED_MODULE_0__["TYPE_TO_PLACEHOLDER"][point.type]} ${point.destination.name}</h3>

      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${point.startDate}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(point.startDate)}</time>
          —
          <time class="event__end-time" datetime="${point.endDate}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(point.endDate)}</time>
        </p>
...
class Point extends _abstract_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(point) {
    super();
    this._point = point;
  }
...
const renderMoneyChart = (moneyCtx, points) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(moneyCtx, {
    ...
    type: `pie`,
    data: {
      labels: moneyByType.map((element) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["capitalizeString"])(element.type)),
      datasets: [{
...
const renderTransportChart = (transportCtx, points) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(transportCtx, {
    ...
    type: `pie`,
    data: {
      labels: transportCount.map((element) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["capitalizeString"])(element.type)),
      datasets: [{
...
const renderTimeSpendChart = (timeSpendCtx, points) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(timeSpendCtx, {
    ...
    type: `pie`,
    data: {
      labels: durationByType.map((element) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["capitalizeString"])(element.type)),
      datasets: [{
      ...
      tooltips: {
        callbacks: {
          label: (tooltipItem, data) => {
            ...
            return `(${data.labels[tooltipItem.index]}) ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getDurationDays"])(tooltipData)}D ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getDurationHours"])(tooltipData)}H — ${tooltipPercentage}%`;
          }
        },
        displayColors: false,
        backgroundColor: `#ffffff`,
...
class Statistics extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
const createTripDaysTemplate = (element, index) => (
  `<li class="trip-days__item  day">
    <div class="day__info">
      ...
      <time class="day__date" datetime="${element ? element[0].startDate : ``}">${element ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(element[0].startDate) : ``}</time>
    </div>
...
class TripDays extends _abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const createTripInfoTemplate = (points) => {
  const startDate = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(points[0].startDate);
  const endDate = points[0].startDate.getMonth() === points[points.length - 1].endDate.getMonth() ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDay"])(points[points.length - 1].endDate) : Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(points[points.length - 1].endDate);
...
class TripSort extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: HIDDEN_CLASS, TYPE_TO_ICON, TYPE_TO_PLACEHOLDER, DEFAULT_TYPE, EMPTY_POINT, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HIDDEN_CLASS", function() { return HIDDEN_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TYPE_TO_ICON", function() { return TYPE_TO_ICON; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TYPE_TO_PLACEHOLDER", function() { return TYPE_TO_PLACEHOLDER; });
...
class FiltersController {
  ...
  render() {
    ...
    Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).forEach((filter) => Object.assign(pointsCountByFilter, {[filter]: this._pointsModel.getPointsWithFilter(filter).length}));
    const container = this._container;
    const oldFiltersComponent = this._filtersComponent;
    this._filtersComponent = new _components_filters_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._activeFilterType, pointsCountByFilter);
    this._filtersComponent.setFilterChangeHandler(this._onFilterChange);
    if (oldFiltersComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filtersComponent, oldFiltersComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filtersComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTER);
    }
  }
...
/* harmony import */ var _components_add_edit_point_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/add-edit-point.js */ "./src/components/add-edit-point.js");
...
const getType = (rawType) => {
  const keys = Object.keys(_const_js__WEBPACK_IMPORTED_MODULE_4__["TYPE_TO_PLACEHOLDER"]);
...
const parseFormData = (formData, generatedOffers) => {
  ...
  return new _models_point_model_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
class PointController {
  ...
  render(point, mode) {
    ...
    this._pointComponent = new _components_point_js__WEBPACK_IMPORTED_MODULE_1__["default"](point);
    this._addEditPointComponent = new _components_add_edit_point_js__WEBPACK_IMPORTED_MODULE_0__["default"](point, this._mode, this._offers, this._destinations);
    ...
    this._addEditPointComponent.setFavoriteButtonClickHandler(() => {
      const newPoint = _models_point_model_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(point);
    ...
    switch (mode) {
      case Mode.VIEW:
        if (oldPointComponent && oldAddEditPointComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._pointComponent, oldPointComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._addEditPointComponent, oldAddEditPointComponent);
          this._replaceAddEditToPoint();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._pointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.ADD:
        if (oldPointComponent && oldAddEditPointComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldPointComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldAddEditPointComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeydown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._addEditPointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
        break;
    }
  }
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._addEditPointComponent);
  ...
  _replaceAddEditToPoint() {
    ...
    if (document.contains(this._addEditPointComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._pointComponent, this._addEditPointComponent);
    }
    this._mode = Mode.VIEW;
  }
  ...
  _replacePointToAddEdit() {
    this._onViewChange();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._addEditPointComponent, this._pointComponent);
  ...
  _onEscKeydown(evt) {
    ...
    if (isEscKeydown) {
      if (this._mode === Mode.ADD) {
        this._onDataChange(this, _const_js__WEBPACK_IMPORTED_MODULE_4__["EMPTY_POINT"], null);
      }
      this._replaceAddEditToPoint();
    }
  }
...
/* harmony import */ var _components_no_points_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-points.js */ "./src/components/no-points.js");
/* harmony import */ var _components_trip_days__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/trip-days */ "./src/components/trip-days.js");
/* harmony import */ var _components_trip_info_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/trip-info.js */ "./src/components/trip-info.js");
/* harmony import */ var _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/trip-sort.js */ "./src/components/trip-sort.js");
...
const renderPoints = (pointsContainer, points, sortType, onDataChange, onViewChange, offers, destinations) => {
  ...
  const renderTripDay = (group, day) => {
    const newDay = new _components_trip_days__WEBPACK_IMPORTED_MODULE_4__["default"](group, day);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(pointsContainer, newDay, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    return newDay;
  };

  let groupedPoints = [];

  if (sortType !== _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT) {
    groupedPoints = [points.slice()];
    groupedPoints.forEach((group) => {
      const newDay = renderTripDay(null, null);
      group.map((element) => {
        const pointController = new _point_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](newDay.getElement().querySelector(`.trip-events__list`), onDataChange, onViewChange, offers, destinations);
        pointController.render(element, _point_controller_js__WEBPACK_IMPORTED_MODULE_7__["Mode"].VIEW);
...
class TripController {
  constructor(container, pointsModel, api, statistics) {
    ...
    this._noPointsComponent = new _components_no_points_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._tripSortComponent = new _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._boardComponent = new _components_board_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._creatingPoint = null;

    this._sortType = _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT;
  ...
  hide() {
    if (this._container) {
      this._container.classList.add(_const_js__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
    }
  }

  show() {
    if (this._container) {
      this._container.classList.remove(_const_js__WEBPACK_IMPORTED_MODULE_1__["HIDDEN_CLASS"]);
    }
  }
  ...
  render() {
    ...
    if (isNoPoints) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._noPointsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      return;
    }
    ...
    this._tripInfoComponent = new _components_trip_info_js__WEBPACK_IMPORTED_MODULE_5__["default"](sortPointsByDate(allPoints));
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(tripInfoContainer, this._tripInfoComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._tripSortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, this._boardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  ...
  createPoint() {
    ...
    this._creatingPoint = new _point_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](tripDaysContainer, this._onDataChange, this._onViewChange, this._pointsModel.getOffers(), this._pointsModel.getDestinations());
    _const_js__WEBPACK_IMPORTED_MODULE_1__["EMPTY_POINT"].type = _const_js__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_TYPE"];
    this._creatingPoint.render(_const_js__WEBPACK_IMPORTED_MODULE_1__["EMPTY_POINT"], _point_controller_js__WEBPACK_IMPORTED_MODULE_7__["Mode"].ADD);
  }
  ...
  _sortPointsBySortType(points, sortType) {
    let sortedPoints = [];
    switch (sortType) {
      case _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT:
        sortedPoints = points.slice();
        this._sortType = _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT;
        break;
      case _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DURATION:
        sortedPoints = points.slice().sort((a, b) => (b.endDate - b.startDate) - (a.endDate - a.startDate));
        this._sortType = _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].DURATION;
        break;
      case _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].PRICE:
        sortedPoints = points.slice().sort((a, b) => b.basePrice - a.basePrice);
        this._sortType = _components_trip_sort_js__WEBPACK_IMPORTED_MODULE_6__["SortType"].PRICE;
        break;
    }
    return sortedPoints;
  }
  ...
  _onDataChange(pointController, oldData, newData) {
    if (oldData === _const_js__WEBPACK_IMPORTED_MODULE_1__["EMPTY_POINT"]) {
      this._creatingPoint = null;
      if (newData === null) {
        ...
        this._api.createPoint(newData)
          .then((pointModel) => {
            ...
            pointController.render(pointModel, _point_controller_js__WEBPACK_IMPORTED_MODULE_7__["Mode"].VIEW);
...
/* harmony import */ var _components_loading_points_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/loading-points.js */ "./src/components/loading-points.js");
/* harmony import */ var _models_points_model_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./models/points-model.js */ "./src/models/points-model.js");
...
const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_0__["default"](REMOTE_HOST, AUTHORIZATION_KEY);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_2__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_1__["default"](api, store);
const pointsModel = new _models_points_model_js__WEBPACK_IMPORTED_MODULE_9__["default"]();
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(menuContainer, menuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTER);

const filtersContainer = document.querySelector(`.trip-controls h2:nth-of-type(2)`);
const filtersController = new _controllers_filters_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](filtersContainer, pointsModel);

const tripPointsContainer = document.querySelector(`.trip-events`);

const loadingPointsComponent = new _components_loading_points_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(tripPointsContainer, loadingPointsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
...
apiWithProvider.getDestinations()
  ...
  .then((points) => {
    ...
    const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_7__["default"](pointsModel);
    const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](tripPointsContainer, pointsModel, apiWithProvider, statisticsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(tripPointsContainer, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTER);
    statisticsComponent.hide();
    menuComponent.setOnChange((menuItem) => {
      switch (menuItem) {
        case _components_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].NEW_EVENT:
          menuComponent.setActiveItem(_components_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].TABLE);
          statisticsComponent.hide();
          tripController.show();
        ...
        case _components_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].STATS:
          menuComponent.setActiveItem(_components_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].STATS);
...
class PointsModel {
  ...
  getPointsWithFilter(filter) {
    return Object(_utils_filters_js__WEBPACK_IMPORTED_MODULE_0__["getPointsByFilter"])(this._points, filter);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: capitalizeString, getDurationDays, getDurationHours, getDurationMinutes, formatDay, formatTime, formatDate, isFutureDate, isPastDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "capitalizeString", function() { return capitalizeString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationDays", function() { return getDurationDays; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationHours", function() { return getDurationHours; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationMinutes", function() { return getDurationMinutes; });
...
const capitalizeString = (string) => string ? string.split(`-`).map((element) => element[0].toUpperCase().concat(element.slice(1))).join(`-`) : ``;

const getDurationDays = (duration) => moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).days();

const getDurationHours = (duration) => moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).hours();

const getDurationMinutes = (duration) => moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration).minutes();

const formatDay = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`DD`);

const formatTime = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`HH:mm`);

const formatDate = (date) => moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`DD MMM`);
...
/*!******************************!*\
  !*** ./src/utils/filters.js ***!
  \******************************/
/*! exports provided: getFuturePoints, getPastPoints, getPointsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const getFuturePoints = (points) => points.filter((element) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["isFutureDate"])(element.startDate));

const getPastPoints = (points) => points.filter((element) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["isPastDate"])(element.endDate));
